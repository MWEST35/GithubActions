[![Run App Michael K West](https://github.com/MWEST35/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/MWEST35/GithubActions/actions/workflows/run-app.yaml)
